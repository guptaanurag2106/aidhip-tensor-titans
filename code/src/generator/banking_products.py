...
def generate_financial_products():
    product_categories = {
        ...
        "Insurance": ["Home", "Health", "Life", "Auto", "Travel", "Pet", "Business"],
        "Loan": ["Personal", "Home", "Vehicle", "Education", "Business"],
        "Investment": ["Mutual Fund", "FD", "Stocks", "Gold", "Real Estate"],
    }
...
def main():
    ...
    json_file = os.path.join(output_dir, "financial_products.json")
