...
def generate_org_financial_products():
    product_categories = {
        "Credit Card": ["Basic", "Gold", "Platinum", "Luxury", "Dining", "Travel"],
        "Insurance": ["Commercial Property", "Cybersecurity", "General Liability"],
        "Loan": [
            "Working Capital",
        ...
        "Investment": ["Corporate FD", "Government & Corporate Bonds", "REITs", "ETFs"],
    }
    ...
    product_details = {
        ...
        "Insurance": {
            ...
            "specialized_coverage": {
                ...
                "Cybersecurity": {
                    "Entry": "Data Breach",
                    "Standard": "Breach & Recovery",
                    "Premium": "Full Cyber Protection",
                    "Elite": "Enterprise Cyber Shield",
                },
                "General Liability": {
                    "Entry": "Basic Liability",
                    "Standard": "Standard Liability",
                    "Premium": "Extended Liability",
                    "Elite": "Complete Liability Shield",
                },
            },
        },
        "Loan": {
    ...
    for category, subcategories in product_categories.items():
        for subcategory in subcategories:
            for tier in tiers:
                ...
                modified_attrs = {
                    attr: min(
                        10, max(1, round(base_attrs[attr] * tier_modifiers[tier][attr]))
                    )
                ...
                for detail_type, detail_values in product_details[category].items():
                    if (
                        subcategory in detail_values
                        and tier in detail_values[subcategory]
                    ):
                        details[detail_type] = detail_values[subcategory][tier]

                description, benefits = generate_description_and_benefits(
...
def generate_description_and_benefits(category, subcategory, tier):
        ...
        "Credit Card": {
            "Basic": {
                "Entry": [
                    ...
                    "Up to 3 employee cards",
                ],
                "Standard": [
                    "Moderate rewards rate",
                    "Basic expense reporting",
                    "Up to 5 employee cards",
                ],
                "Premium": [
                    "Enhanced rewards",
                ...
                "Elite": [
                    ...
                    "Up to 15 employee cards",
                ],
            },
            "Gold": {
                "Entry": [
                    "Enhanced cashback on business categories",
                    "Basic travel insurance",
                    "Up to 5 employee cards",
                ],
                "Standard": [
                    "Superior rewards on business expenses",
            ...
            "Platinum": {
                "Entry": [
                    "Premium rewards on key business categories",
                ...
                "Standard": [
                    ...
                    "Global assistance",
                    "Up to 20 employee cards",
                ],
                "Premium": [
                    "Comprehensive reward system",
                    "Premium concierge",
                    "Up to 30 employee cards",
                ],
                "Elite": [
            ...
            "Luxury": {
                ...
                "Elite": [
                    ...
                    "Bespoke services",
                    "Up to 100 employee cards",
                ],
            },
            "Dining": {
                "Entry": [
                    "Enhanced rewards on dining",
                    "Restaurant reservations",
                    "Up to 5 employee cards",
                ],
                "Standard": [
                    "Superior dining rewards",
                    "Priority restaurant bookings",
                    "Up to 10 employee cards",
                ],
                "Premium": [
                    "Extensive food & beverage rewards",
                    "VIP dining experiences",
                    "Up to 20 employee cards",
                ],
                "Elite": [
                    "Maximum dining rewards",
            ...
            "Travel": {
                ...
                "Premium": [
                    "Extensive global rewards",
                    "Premium lounge access",
                    "Up to 25 employee cards",
                ],
                "Elite": [
                    "Maximum travel privileges",
                    "Global elite status",
                    "Up to 40 employee cards",
                ],
            },
        },
        "Insurance": {
            "Commercial Property": {
                ...
                "Premium": [
                    ...
                    "Full business interruption coverage",
        ...
        "Loan": {
            "Working Capital": {
                "Entry": [
                    ...
                    "No collateral for established businesses",
                ],
                "Standard": [
            ...
            "Commercial Real Estate": {
                ...
                "Standard": [
                    "Enhanced LTV options",
                    "Competitive rates",
                    "Flexible term structures",
                ],
                "Premium": [
                    "Preferred LTV ratios",
            ...
            "Startup Funding": {
                ...
                "Premium": [
                    "Comprehensive startup package",
                    "Minimal collateral needs",
                    "Business development support",
                ],
                "Elite": [
                    "Maximum funding potential",
                    "Collateral-free options",
                    "Full business incubation support",
                ],
            },
        },
        "Investment": {
            "Corporate FD": {
                "Entry": [
                    "Higher than retail interest rates",
                    "Flexible tenure options",
                    "Premature withdrawal facility",
                ],
                "Standard": [
                    "Enhanced interest benefits",
                    "Multiple reinvestment options",
                    "Preferential rates",
                ],
                "Premium": [
            ...
            "Government & Corporate Bonds": {
                ...
                "Premium": [
                    ...
                    "Premium bond access",
                    "Tailored maturity laddering",
                ],
                "Elite": [
                    "Maximum yield optimization",
                    "Exclusive bond offerings",
            ...
            "REITs": {
                ...
                "Standard": [
                    "Enhanced property diversification",
            ...
            "ETFs": {
                ...
                "Premium": [
                    "Strategic multi-asset exposure",
                    "Premium ETF access",
                    "Portfolio rebalancing",
                ],
                "Elite": [
                    "Maximum diversification",
                    "Exclusive ETF offerings",
    ...
    if (
        ...
        and subcategory in descriptions[category]
        and tier in descriptions[category][subcategory]
    ):
    ...
    if (
        category in benefits
        and subcategory in benefits[category]
        and tier in benefits[category][subcategory]
    ):
...
def main():
    ...
    json_file = os.path.join(output_dir, "org_financial_products.json")
