...
import CustomerRecommendations from "./customer-recommendations";

export default function CustomerDashboard() {
    const { data: customerIds, isLoading: isCustomerIdsLoading } =
        useCustomerIds();
    const [selectedCustomerId, setSelectedCustomerId] = useState<
        string | undefined
    >("CUST_1");
    const { data: customerInfo, isLoading: isCustomerLoading } = useCustomerInfo(
        selectedCustomerId || ""
    );
        ...
        <div className="container mx-auto py-6">
            ...
            <Card className="mb-6">
                <CardHeader>
                    ...
                    <CardDescription>
                        Choose a customer to view their information
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex items-end gap-2">
                        ...
                        {customerInfo && (
                            ...
                            >
                                ...
                                <span>Run AI</span>
                                {isCustomerLoading ||
                                    (isRunningAi && <span className="ml-2 animate-spin">⟳</span>)}
                            </Button>
                        )}
                    </div>
                </CardContent>
                        ...
                        <>
                            ...
                            <Tabs defaultValue="purchases" className="w-full">
                                ...
                                <TabsContent value="recommendations">
                                    <CustomerRecommendations customerInfo={customerInfo} />
                                </TabsContent>
                            </Tabs>
                        </>
                    )}
